...
async def add_to_wardrobe(
    ...
    with open(filepath, "wb") as f:
        f.write(image_bytes)
    #save each detected item to wardrobe
    items = []
...
async def recommend(
    ...
    #get suggestions (checks wardrobe + pexels)
    ...
    result = get_recommendations_with_images(image_bytes, wardrobe_labels)
